...
export const metadata: Metadata = { title: "料金｜Wani san Web", description: "Webサイト制作・運用、SEO、マーケティング支援、AI・業務改善の料金目安をご案内します。" };

export default function PricingPage() {
  return <main className="platform-page"><SiteHeader current="pricing" />
    <section className="platform-hero platform-hero--compact"><span className="section-kicker" aria-hidden="true">PRICING</span><h1>料金の目安</h1><p>Webサイトの小さな更新から、集客支援、AI・業務改善まで。依頼規模を判断できる開始価格を掲載しています。</p><div className="hero-actions"><a className="button button--primary" href="/contact">予算に合う方法を無料相談する <b>→</b></a></div></section>
