...
const sections = [
  ...
  { id:"contents", number:"03", title:"提供内容について", body:<dl><div><dt>ナレッジ</dt><dd>Webの用語や仕組みを、基礎から実務まで確認できる形で解説します。</dd></div><div><dt>コラム</dt><dd>Web担当者の仕事術、AI活用、サイト改善を、課題と実践の視点で掘り下げます。</dd></div><div><dt>ニュース</dt><dd>SEO・AI・ブラウザ・セキュリティなどの変化を、実務への影響とともに整理します。</dd></div><div><dt>サービス</dt><dd>無料ツール、テンプレート、簡易診断、改善提案、制作・運用支援をまとめて案内します。</dd></div></dl> },
  ...
  { id:"contact", number:"09", title:"お問い合わせ", body:<><p>記事の誤記・修正依頼に加え、Webサイト診断、改善、制作、SEO、CMS、AI導入、運用についてご相談いただけます。</p><p className="about-note">お問い合わせフォームは現在、受付機能を準備中です。画面と入力項目は<a href="/contact">お問い合わせページ</a>でご確認いただけます。</p></> },
