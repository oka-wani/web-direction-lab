...
const sections = [
  ...
  { id:"contents", number:"03", title:"提供内容について", body:<dl><div><dt>サービス</dt><dd>小規模Webサイト制作、更新できるサイト制作、既存サイト改善、Web運用、業務効率化ツール、Web・AI活用相談に対応します。</dd></div><div><dt>コラム</dt><dd>Webサイト制作・改善・運用、SEO、業務効率化を、読者が判断し実践できる形で解説します。</dd></div><div><dt>ナレッジ</dt><dd>Webの用語や仕組みを、基礎から実務まで確認できる形で解説します。</dd></div><div><dt>ニュース</dt><dd>SEO・AI・ブラウザ・セキュリティなどの変化を、実務への影響とともに整理します。</dd></div></dl> },
