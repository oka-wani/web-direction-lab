...
const sections = [
  ...
  { id:"contents", number:"03", title:"提供内容について", body:<dl><div><dt>ナレッジ</dt><dd>Webの用語や仕組みを、基礎から実務まで確認できる形で解説します。</dd></div><div><dt>コラム</dt><dd>仕事術とAI・効率化を、興味を持って読み進められる切り口で掘り下げます。</dd></div><div><dt>ニュース</dt><dd>SEO・AI・ブラウザ・セキュリティなどの変化を、実務への影響とともに整理します。</dd></div><div><dt>サービス・ツール</dt><dd>Webサイト診断・改善提案、SEO改善支援、小規模サイト・LP制作、運用支援、実務ツール・テンプレートをまとめて案内します。</dd></div></dl> },
