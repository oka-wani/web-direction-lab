...
export default function InquiryForm() {
  ...
  return <form className="inquiry-form" onSubmit={handleSubmit}>
    ...
    <label><span>相談したい内容 <b>必須</b></span><select name="service" required defaultValue=""><option value="" disabled>選択してください</option><option>何を依頼すべきか相談したい</option><option>小規模Webサイトを制作したい</option><option>自社で更新できるサイトを制作したい</option><option>今のWebサイトを診断・改善したい</option><option>更新や運用を依頼したい</option><option>業務効率化ツールを制作したい</option><option>Web・AIの活用方法を相談したい</option><option>その他</option></select></label>
    ...
    <label><span>相談内容 <b>必須</b></span><textarea name="message" rows={8} required placeholder="現在困っていること、実現したいこと、繰り返し行っている作業などをご記入ください。" /></label>
