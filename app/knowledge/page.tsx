...
export default function KnowledgePage() {
  return <main className="knowledge-hub"><SiteHeader current="knowledge" />
    <section className="knowledge-hub-hero knowledge-hub-hero--simple"><div><div className="knowledge-hero-copy"><p className="section-kicker">WEB KNOWLEDGE</p><h1>Webナレッジ</h1><p className="knowledge-hero-subtitle">Webの知識を、基礎から実務まで。</p><p className="knowledge-hero-description">基礎知識は学習順に、ナレッジはカテゴリやキーワードから。目的に合わせて二つの入口を使い分けられます。</p></div><nav className="knowledge-entry-links" aria-label="Webナレッジ内のコンテンツ"><a href="#basics"><span>01</span><div><b>基礎知識</b><small>順番に学ぶ</small></div><i>↓</i></a><a href="#articles"><span>02</span><div><b>ナレッジ</b><small>テーマから探す</small></div><i>↓</i></a></nav></div></section>
