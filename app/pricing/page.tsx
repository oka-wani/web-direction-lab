...
const contentOptions = [
  ...
  ["画像調整の追加", "基本料金に含まれる10点を超える画像のトリミング、明るさ・サイズ・形式を調整します。", "1,000円／10点"],
  ["図版・イラスト・バナー制作", "説明図、イラスト、メイン画像、告知バナーなどを制作します。", "個別見積"],
...
export default function PricingPage() {
  return <main className="order-page package-page"><SiteHeader current="pricing" />
    ...
    <section className="package-hero" id="basic-package">
      <div className="package-hero-copy"><span>PRICING</span><h1>料金・プラン</h1><p>まずは5ページまでの基本制作パッケージ。必要なページや機能だけを、追加オプションとして組み合わせます。</p><div className="order-actions"><a className="order-primary-link" href="/contact">無料で相談する <b>→</b></a><a className="order-secondary-link" href="#included">基本料金の内容を見る <b>↓</b></a></div></div>
