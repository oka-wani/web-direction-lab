...
export const metadata: Metadata = { title: "よくある質問｜Wani san Web", description: "Webマーケティング、Webサイト、AI・業務改善のご相談に関するよくある質問をまとめています。" };
...
export default function FaqPage() {
  return <main className="platform-page"><SiteHeader />
    ...
    <section className="platform-wide-band"><div><span className="section-kicker" aria-hidden="true">CONTACT</span><h2>解決しないことは、直接ご相談ください。</h2><p>依頼内容が固まっていなくても、現在のお悩みから整理します。</p></div><a className="button button--primary" href="/contact">無料で相談する <b>→</b></a></section>
    <SiteFooter />
  </main>;
}
