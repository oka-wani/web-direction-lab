...
export default function ServicesPage() {
  return <main className="platform-page"><SiteHeader current="services" />
    <section className="platform-hero platform-hero--services"><span className="section-kicker" aria-hidden="true">SERVICES</span><h1>Webの改善に必要なものを、ここにまとめました。</h1><p>相談・診断・制作などの支援サービスと料金の目安、日々の実務に使えるツールを、目的に合わせて選べます。</p></section>
