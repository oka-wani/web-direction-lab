...
export const GET:APIRoute=async({params})=>{
  ...
  const headers=new Headers();object.writeHttpMetadata(headers);if(asset!=="proposal.pdf")headers.set("content-type","text/html; charset=utf-8");headers.set("cache-control","private, no-store");headers.set("x-robots-tag","noindex, nofollow");
