...
const filter = `drawbox=x=0:y=0:w=1080:h=210:color=0xa8d65e:t=fill,drawtext=font='Noto Sans CJK JP':text='WANI SAN WEB':fontcolor=0x075b3a:fontsize=42:x=(w-text_w)/2:y=72,drawtext=font='Noto Sans CJK JP':text='${title.replaceAll(":", "\\:").replaceAll("'", "’")}':fontcolor=white:fontsize=74:x=80:y=330:box=1:boxcolor=0x075b3acc:boxborderw=28,ass='${assPath.replaceAll("'", "'\\''").replaceAll(":", "\\:")}',drawtext=font='Noto Sans CJK JP':text='※音声はAIで生成しています':fontcolor=0xa8d65e:fontsize=30:x=(w-text_w)/2:y=h-120`;
