...
const sections = [
  ...
  { id: "process", number: "05", title: "制作の進め方", body: <><p>お問い合わせ後、まずヒアリングフォームへご回答いただきます。その内容をもとに打ち合わせを行い、目的・ターゲット・必要な機能・デザインの方向性を整理して、サイト方針を確定します。</p><p>方針確定後は、構成・デザイン、サイト制作、最終確認、公開の順に進めます。完成イメージを確認してから実装へ進むことを基本とします。</p><p><a href="/flow">詳しい制作フローを見る →</a></p></> },
