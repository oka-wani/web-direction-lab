...
export default function ServicesPage() {
  return <main className="order-page"><SiteHeader current="services" />
    ...
    <section className="order-section order-section--tint" id="pricing"><div className="order-section-heading"><div><span>PRICING</span><h2>料金の目安</h2></div><p>5ページまで3万円。6ページ目以降は1ページ2,000円で追加できます。機能や独自対応は、着手前に範囲と料金をご案内します。</p></div><div className="order-price-feature"><div><small>BASIC PACKAGE</small><h3>基本制作パッケージ</h3><p>5ページ、レスポンシブ、基本SEO、アクセシビリティ、公開作業を含みます。</p></div><strong>30,000<small>円</small></strong></div><div className="order-actions"><a className="order-secondary-link" href="/pricing">料金・オプションを見る <b>→</b></a></div><div className="pricing-notes"><h3>料金が変わる主な条件</h3><ul><li>6ページ目以降：1ページにつき2,000円</li><li>独自モジュール、CMS、問い合わせフォーム、外部サービス連携</li><li>原稿・写真・ロゴなど素材準備の範囲</li><li>ドメイン、外部サービス等の実費</li></ul></div></section>
